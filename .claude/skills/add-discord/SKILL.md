---
name: add-discord
description: Add Discord bot channel integration to NanoPilot.
---

# Add Discord Channel

This skill adds Discord support to NanoPilot, then walks through interactive setup.
...
```bash
git remote add discord https://github.com/ridermw/nanopilot-discord.git
```
...
4. Service is running: `launchctl list | grep nanopilot`
...
- @mention translation (Discord `<@botId>` → NanoPilot trigger format)
