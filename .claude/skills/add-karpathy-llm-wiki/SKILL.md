...
description: Add a persistent wiki knowledge base to a NanoPilot group. Based on Karpathy's LLM Wiki pattern. Triggers on "add wiki", "wiki", "knowledge base", "llm wiki", "karpathy wiki".
---

# Add Karpathy LLM Wiki

Set up a persistent wiki knowledge base on NanoPilot, based on Karpathy's LLM Wiki pattern.
...
If yes, schedule via `mcp__nanopilot__schedule_task` with a prompt based on the pattern's Lint operation.
