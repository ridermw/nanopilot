---
name: add-pdf-reader
description: Add PDF reading to NanoPilot agents. Extracts text from PDFs via pdftotext CLI. Handles WhatsApp attachments, URLs, and local files.
---
...
```bash
tail -f logs/nanopilot.log | grep -i pdf
```
