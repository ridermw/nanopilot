...
This skill adds Slack support to NanoPilot, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/ridermw/nanopilot-slack.git
```
...
>
> The JID format for NanoPilot is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.nanopilot`
