---
name: capabilities
description: Show what this NanoPilot instance can do — installed skills, available tools, and system info. Read-only. Use when the user asks what the bot can do, what's installed, or runs /capabilities.
---

# /capabilities — System Capabilities Report

Generate a structured read-only report of what this NanoPilot instance can do.
...
- **MCP:** mcp__nanopilot__* (messaging, tasks, group management)

### 3. MCP server tools

The NanoPilot MCP server exposes these tools (via `mcp__nanopilot__*` prefix):
