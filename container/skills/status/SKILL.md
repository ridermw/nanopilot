...
- **MCP:** mcp__nanopilot__* (send_message, schedule_task, list_tasks, pause_task, resume_task, cancel_task, update_task, register_group)
...
```
Call mcp__nanopilot__list_tasks to get scheduled tasks.
```
