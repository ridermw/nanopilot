/**
 * parseTextStyles — convert the agent's Markdown output to channel-native formatting.
 *
 * The agent outputs standard Markdown. Each channel has its own text style syntax:
...
/**
 * Parse the agent's Markdown into a plain string + Signal textStyle ranges.
 *
